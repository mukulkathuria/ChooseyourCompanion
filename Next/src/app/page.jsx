                ...
                <div className="popup-content2">
                    ...
                    <div className="p-out">
                        <div className="p-in">
                            ...
                            <hr />
                            <a style={{ color: "#fff", cursor: "pointer" }} className="cmp-btn ml-4" id="openPopup2">continue for companion</a>
                            <hr />
                            <hr />
                            <Link href="/ProfilePage" style={{ color: "#fff", cursor: "pointer" }} className="cmp-btn2 ml-4">continue as companion</Link>
                            <hr />
                        </div>
                    </div>
                </div>
